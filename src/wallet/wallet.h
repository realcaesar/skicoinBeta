...
#ifndef SKICOIN_WALLET_WALLET_H
#define SKICOIN_WALLET_WALLET_H
...
enum WalletFeature
{
    ...
    FEATURE_COMPRPUBKEY = 2900000, // compressed public keys
    FEATURE_HD = 3000000,    // Hierarchical key derivation after BIP32 (HD Wallet), BIP44 (multi-coin), BIP39 (mnemonic)
...
public:
     ...
     * on this skicoin node, and set to 0 for transactions that were created
...
public:
     ...
     */
    void AvailableCoins(std::vector<COutput>& vCoins, bool fOnlyConfirmed=true, const CCoinControl *coinControl = NULL, bool fIncludeZeroValue=false, AvailableCoinsType nCoinType=ALL_COINS, bool fUseInstantSend = false, bool fIncludeSkicoinAliasBalances = false, bool fIncludeSkicoinAliasOutputs = false) const;
    ...
    /// Get 10500 SKI output and keys which can be used for the Masternode
