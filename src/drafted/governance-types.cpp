...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "SkicoinNetwork") type = SkicoinNetwork;
    if(strType == "SkicoinNetworkVariable") type = SkicoinNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == SkicoinNetwork) s = "SkicoinNetwork";
    if(type == SkicoinNetworkVariable) s = "SkicoinNetworkVariable";
