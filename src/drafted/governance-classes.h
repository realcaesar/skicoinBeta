 ...
 *
 *   // network
 *   CSkicoinNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.skicoin.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CSkicoinNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
public:
    CSkicoinNetwork(UniValue objIn)
    {
...
// // can be under: SkicoinNetwork
// //   -- signature requirements : Key1(User)
// class CSkicoinNetworkVariable : public CGovernanceObject
// {
// private:
