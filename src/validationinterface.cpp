...
void RegisterValidationInterface(CValidationInterface* pwalletIn) {
	...
	g_signals.NotifySkicoinUpdate.connect(boost::bind(&CValidationInterface::NotifySkicoinUpdate, pwalletIn, _1, _2));
...
void UnregisterValidationInterface(CValidationInterface* pwalletIn) {
	...
	g_signals.NotifySkicoinUpdate.disconnect(boost::bind(&CValidationInterface::NotifySkicoinUpdate, pwalletIn, _1, _2));
...
void UnregisterAllValidationInterfaces() {
	...
	g_signals.NotifySkicoinUpdate.disconnect_all_slots();
