...
{
    BOOST_CHECK(TestSplitHost("www.skicoin.org", "www.skicoin.org", -1));
    BOOST_CHECK(TestSplitHost("[www.skicoin.org]", "www.skicoin.org", -1));
    BOOST_CHECK(TestSplitHost("www.skicoin.org:80", "www.skicoin.org", 80));
    BOOST_CHECK(TestSplitHost("[www.skicoin.org]:80", "www.skicoin.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:4040", "127.0.0.1", 4040));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:4040", "127.0.0.1", 4040));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:4040", "::ffff:127.0.0.1", 4040));
    BOOST_CHECK(TestSplitHost("[::]:4040", "::", 4040));
    BOOST_CHECK(TestSplitHost("::4040", "::4040", -1));
    BOOST_CHECK(TestSplitHost(":4040", "", 4040));
    BOOST_CHECK(TestSplitHost("[]:4040", "", 4040));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:4040", "127.0.0.1:4040"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:4040", "[::]:4040"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
...
BOOST_AUTO_TEST_CASE(netbase_getgroup)
{
    ...
    BOOST_CHECK(ResolveIP("2002:102:304:4040:4040:4040:4040:4040").GetGroup() == boost::assign::list_of((unsigned char)NET_IPV4)(1)(2)); // RFC3964
    BOOST_CHECK(ResolveIP("2001:0:4040:4040:4040:4040:FEFD:FCFB").GetGroup() == boost::assign::list_of((unsigned char)NET_IPV4)(1)(2)); // RFC4380
    BOOST_CHECK(ResolveIP("FD87:D87E:EB43:edb1:8e4:3588:e546:35ca").GetGroup() == boost::assign::list_of((unsigned char)NET_TOR)(239)); // Tor
    BOOST_CHECK(ResolveIP("2001:470:abcd:4040:4040:4040:4040:4040").GetGroup() == boost::assign::list_of((unsigned char)NET_IPV6)(32)(1)(4)(112)(175)); //he.net
    BOOST_CHECK(ResolveIP("2001:2001:4040:4040:4040:4040:4040:4040").GetGroup() == boost::assign::list_of((unsigned char)NET_IPV6)(32)(1)(32)(1)); //IPv6
