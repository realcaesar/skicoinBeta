...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
	...
	UniValue r;
	CPubKey demoPubkey;
	CSkicoinAddress demoAddress;
	UniValue retValue;
	string strAccount = "walletDemoAccount";
	CSkicoinAddress setaccountDemoAddress;
	{
		LOCK(pwalletMain->cs_wallet);

		demoPubkey = pwalletMain->GenerateNewKey(0, false);
		demoAddress = CSkicoinAddress(CTxDestination(demoPubkey.GetID()));
		...
		setaccountDemoAddress = CSkicoinAddress(CTxDestination(setaccountDemoPubkey.GetID()));
	}
	/*********************************
	* 			setaccount
	*********************************/
	...
	*********************************/
	...
	BOOST_CHECK(CSkicoinAddress(retValue.get_str()).Get() == demoAddress.Get());
	...
	*********************************/
	...
	BOOST_CHECK(CSkicoinAddress(arr[0].get_str()).Get() == demoAddress.Get());
