...
#define BOOST_TEST_MODULE Skicoin Test Suite

#include "test_skicoin.h"
...
TestingSetup::TestingSetup(const std::string& chainName) : BasicTestingSetup(chainName)
{
    const CChainParams& chainparams = Params();
        ...
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_skicoin_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
