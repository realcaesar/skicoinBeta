...
#ifndef SKICOIN_TEST_SCRIPTNUM10_H
#define SKICOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Skicoin Core 0.10.0, for cross-comparison.
 */
public:
