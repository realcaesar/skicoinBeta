...
#ifndef SKICOIN_SCRIPT_SCRIPT_H
#define SKICOIN_SCRIPT_SCRIPT_H
...
enum opcodetype
{
	...
	// skicoin extended reserved 
	OP_SKICOIN_ALIAS = 0x01,
	OP_SKICOIN_CERT = 0x02,
	OP_SKICOIN_ESCROW = 0x03,
	OP_SKICOIN_OFFER = 0x04,
	OP_SKICOIN_ASSET = 0x05,
	OP_SKICOIN_ASSET_ALLOCATION = 0x06,
    OP_FALSE = OP_0,
    OP_PUSHDATA1 = 0x4c,
    OP_PUSHDATA2 = 0x4d,
    OP_PUSHDATA4 = 0x4e,
...
public:
    ...
    /**
     * Pre-version-0.6, Skicoin always counted CHECKMULTISIGs
