 ...
 */
#ifndef SKICOIN_UTIL_H
#define SKICOIN_UTIL_H
...
extern const char * const SKICOIN_CONF_FILENAME;
extern const char * const SKICOIN_PID_FILENAME;
...
{
    std::string s = strprintf("skicoin-%s", name);
