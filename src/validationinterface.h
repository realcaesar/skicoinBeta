...
#ifndef SKICOIN_VALIDATIONINTERFACE_H
#define SKICOIN_VALIDATIONINTERFACE_H
...
protected:
	...
	virtual void NotifySkicoinUpdate(const char *value, const char *topic) {}
...
struct CMainSignals {
	...
	/** Notifies listeners of an updated skicoin payload with a topic. */
	boost::signals2::signal<void(const char *value, const char *topic)> NotifySkicoinUpdate;
...
#endif // SKICOIN_VALIDATIONINTERFACE_H
