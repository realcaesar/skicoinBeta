    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("SKI-light"), QVariant("light"));
    ui->theme->addItem(QString("SKI-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("SKI-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("SKI-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("SKI-traditional"), QVariant("trad"));
    
    /* Language selector */
    QDir translations(":translations");

    ui->skicoinAtStartup->setToolTip(ui->skicoinAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->skicoinAtStartup->setText(ui->skicoinAtStartup->text().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new SkicoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->skicoinAtStartup, OptionsModel::StartAtStartup);
