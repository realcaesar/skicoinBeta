...
#ifndef SKICOIN_QT_OPTIONSMODEL_H
#define SKICOIN_QT_OPTIONSMODEL_H
...
/** Interface from Qt to configuration data structure for Skicoin client.
...
#endif // SKICOIN_QT_OPTIONSMODEL_H
