...
#ifndef SKICOIN_QT_SKICOINUNITS_H
#define SKICOIN_QT_SKICOINUNITS_H
...
/** Skicoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class SkicoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit SkicoinUnits(QObject *parent);

    /** Skicoin units.
      @note Source: https://en.skicoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        SKI,
...
typedef SkicoinUnits::Unit SkicoinUnit;

#endif // SKICOIN_QT_SKICOINUNITS_H
