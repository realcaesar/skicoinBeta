...
#ifndef SKICOIN_RPCSERVER_H
#define SKICOIN_RPCSERVER_H
...
/**
 * Skicoin RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern UniValue pruneskicoinservices(const JSONRPCRequest& request);
...
extern UniValue skicoinlistreceivedbyaddress(const JSONRPCRequest& request);
extern UniValue sendrawtransaction(const JSONRPCRequest& request);
extern UniValue createrawtransaction(const JSONRPCRequest& request);
extern UniValue skicoinsendrawtransaction(const JSONRPCRequest& request);
extern UniValue skicoindecoderawtransaction(const JSONRPCRequest& request);
...
extern UniValue listoffers(const JSONRPCRequest& request);
...
extern UniValue listcerts(const JSONRPCRequest& request);
...
extern UniValue listescrows(const JSONRPCRequest& request);
