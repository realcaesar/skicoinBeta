...
UniValue stop(const JSONRPCRequest& jsonRequest)
{
    ...
    if (jsonRequest.fHelp || jsonRequest.params.size() > 1)
        throw std::runtime_error(
            "stop\n"
            "\nStop Skicoin Core server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "Skicoin Core server stopping";
}
...
{ //  category              name                      actor (function)         okSafe argNames
  ...
  // SKICOIN rpc functions
	...
	{ "wallet", "skicoinsendrawtransaction",		 &skicoinsendrawtransaction,	false ,  {}},
	{ "wallet", "skicoindecoderawtransaction",		 &skicoindecoderawtransaction,	false ,  {}},
	{ "wallet", "skicoinlistreceivedbyaddress",		 &skicoinlistreceivedbyaddress,	false ,  {}},
	{ "wallet", "pruneskicoinservices",          &pruneskicoinservices,          false ,  {}},
	...
	{ "wallet", "listoffers",            &listoffers,            false ,{} },
	...
	{ "wallet", "listcerts",              &listcerts,          false ,{} },
	...
	{ "wallet", "listescrows",      &listescrows,  false ,{} },
	...
	{ "wallet", "listassets",      &listassets,  false ,{} },
...
{
    return "> skicoin-cli " + methodname + " " + args + "\n";
}
