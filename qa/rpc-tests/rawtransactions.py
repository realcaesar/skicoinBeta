...
class RawTransactionsTest(SkicoinTestFramework):
    ...
    def setup_network(self, split=False):
        ...
        #url = "http://skicoinrpc:DP6DvqZtqXarpeNWyN3LZTFchCCyCUuHwNF7E8pX99x1@%s:%d" % ('127.0.0.1', 18370)
