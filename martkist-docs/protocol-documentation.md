...
This document describes the protocol extensions for all additional functionality build into the Skicoin protocol. This doesn't include any of the Skicoin protocol, which has been left intact in the Skicoin project. For more information about the core protocol, please see https://en.skicoin.it/w/index.php?title#Protocol_documentation&action#edit
...
Skicoin Outpoint https://skicoin.org/en/glossary/outpoint
...
Skicoin Input https://skicoin.org/en/glossary/input
...
Skicoin Output https://skicoin.org/en/glossary/output
...
Skicoin Public Key https://skicoin.org/en/glossary/public-key
...
| Field Size | Field Name | Data type | Description |
| ---------- | ----------- | --------- | -------- |
| 41 | vin | [CTxIn](#ctxin) | The unspent output which is holding 10500 SKI
| # | addr | [CService](#cservice) | IPv4 address of the masternode
| 33-65 | pubKeyCollateralAddress | [CPubKey](#cpubkey) | CPubKey of the main 10500 SKI unspent output
...
| 10004 | 5 | INSTANTSEND_MAX_VALUE | Controls the max value for an InstantSend transaction (currently 2000 skicoin)
| 10007 | 8 | MASTERNODE_PAYMENT_ENFORCEMENT | Requires masternodes to be paid by miners when blocks are processed
| 10008 | 9 | SUPERBLOCKS_ENABLED | Superblocks are enabled (the 10% comes to fund the skicoin treasury)
...
| Field Size | Field Name | Data type | Description |
| ---------- | ----------- | --------- | -------- |
| 41 | vin1 | [CTxIn](#ctxin) | The unspent output which is holding 10500 SKI for masternode 1
| 41 | vin2 | [CTxIn](#ctxin) | The unspent output which is holding 10500 SKI for masternode 2
