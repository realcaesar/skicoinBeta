...
official/supported Docker Images found at https://hub.docker.com/r/skicoin/skicoind/
...
**NOTE: Please update the image description at https://hub.docker.com/r/skicoin/skicoind-develop/ when changing the above text**