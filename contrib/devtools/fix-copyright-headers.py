...
// Copyright (c) 2009-2012 The Skicoin Core developers
...
CMD_REGEX= "perl -pi -e 's/(20\d\d)(?:-20\d\d)? The Skicoin/$1-%s The Skicoin/' %s"
REGEX_CURRENT= re.compile("%s The Skicoin" % year)
