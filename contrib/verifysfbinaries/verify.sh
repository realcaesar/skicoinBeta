...
###   This script attempts to download the signature file SHA256SUMS.asc from skicoin.org
...
WORKINGDIR="/tmp/skicoin"
TMPFILE="hashes.tmp"

SIGNATUREFILENAME="SHA256SUMS.asc"
RCSUBDIR="test/"
BASEDIR="https://skicoin.org/bin/"
...
if [ $RET -ne 0 ]; then
   if [ $RET -eq 1 ]; then
      ...
      echo "gpg error. Do you have the Skicoin Core binary release signing key installed?"
   fi
