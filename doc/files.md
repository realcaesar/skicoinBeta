...
* skicoin.conf: contains configuration settings for skicoind or skicoin-qt
* skicoind.pid: stores the process id of skicoind while running
...
* debug.log: contains debug information and general logging generated by skicoind or skicoin-qt
