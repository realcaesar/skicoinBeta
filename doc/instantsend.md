...
This mechanism has been integrated into Bitcore-Node-Skicoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/skicoin/insight-api-skicoin#web-socket-api](https://github.com/skicoin/insight-api-skicoin#web-socket-api) 
* API: [https://github.com/skicoin/insight-api-skicoin#instantsend-transactions](https://github.com/skicoin/insight-api-skicoin#instantsend-transactions) 
