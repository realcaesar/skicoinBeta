...
This document provides guidelines for internationalization of the Skicoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `skicoin_en.ts` remains unchanged.
